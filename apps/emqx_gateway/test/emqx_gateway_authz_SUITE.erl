...
init_per_suite(Config) ->
    ...
    emqx_mgmt_api_test_util:init_suite([emqx_conf, emqx_authz, emqx_auth, emqx_gateway]),
...
end_per_suite(Config) ->
    ...
    emqx_config:erase(gateway),
    emqx_mgmt_api_test_util:end_suite([emqx_gateway, emqx_auth, emqx_authz, emqx_conf]),
    Config.
