...
init_per_suite(Config) ->
    emqx_mgmt_api_test_util:init_suite([emqx_conf, emqx_auth, emqx_auth_file, emqx_auth_redis]),
    Config.

end_per_suite(_Config) ->
    emqx_mgmt_api_test_util:end_suite([emqx_conf, emqx_auth, emqx_auth_file, emqx_auth_redis]).
