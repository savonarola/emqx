...
init_per_suite(Config) ->
    ...
    emqx_mgmt_api_test_util:init_suite([emqx_conf, emqx_auth, emqx_auth_file, emqx_gateway]),
    Config.

end_per_suite(_) ->
    {ok, _} = emqx:remove_config([<<"gateway">>, <<"coap">>]),
    emqx_mgmt_api_test_util:end_suite([emqx_gateway, emqx_auth_file, emqx_auth, emqx_conf]).
