...
-define(SLAVE_GEN_RPC_TCP_PORT, 5870).
...
setup_node(Node, #{} = Opts) ->
    GenRpcTcpServerPort = maps:get(gen_rpc_tcp_server_port, Opts, ?SLAVE_GEN_RPC_TCP_PORT),
    ...
    DefaultEnvHandler =
        fun(emqx) ->
                ...
                application:set_env(gen_rpc, tcp_server_port, GenRpcTcpServerPort),
                ok;
           (_) ->
                ok
        end,
